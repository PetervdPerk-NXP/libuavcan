...
public:
    ...
    /**
     * Allocates @ref uavcan_zephyr::BlockingServiceClient in the heap using shared pointer.
     * The service client will be initialized immediately.
     * @throws uavcan_zephyr::Exception.
     */
    template <typename DataType>
 ...
 * Clock adjustment mode will be detected automatically unless provided explicitly.
 *
 * @throws uavcan_zephyr::Exception, uavcan_zephyr::LibuavcanErrorException.
 */
